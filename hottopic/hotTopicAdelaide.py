...
def make_wordCloud(frequencies):
    ...
    plt.show()
    # save the picture
    wc.to_file(path.join(d,"adelaideHotTopic.png"))
...
def postJson(wordCountDic):
    url = 'http://ec2-13-55-33-247.ap-southeast-2.compute.amazonaws.com:8080/cloud/location/adelaide'
...
def main():
    ...
    URL = "http://ec2-13-55-33-247.ap-southeast-2.compute.amazonaws.com:8080/cloud/twitter/adelaide"
